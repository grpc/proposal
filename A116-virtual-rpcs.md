...
* [Design](#design)
  ...
  * [Data Flow and Multiplexing](#data-flow-and-multiplexing)
    * [Wire Format: HTTP/2 on HTTP/2](#wire-format-http2-on-http2)
    * [Alternative Wire Format](#alternative-wire-format)
    * [Why HTTP/2 on HTTP/2 is Chosen](#why-http2-on-http2-is-chosen)
  * [Flow Control](#flow-control)
  * [Server-Side Architecture: Dual Server Approach](#server-side-architecture-dual-server-approach)
...
![Lifecycle Diagram](A116_graphics/vrpc_flow.png)
...
![HTTP/2 double stack](A116_graphics/vrpc2.png)
