...
Internally, the `outlier_detection` LB policy will store a map with keys that are subchannel addresses (ignoring any attributes), and values that are objects that contain the following:
