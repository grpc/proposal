...
/** Create a completion queue. 
     factory: Completion queue factory obtained by calling the grpc_completion_queue_factory_lookup API
     attr: Completion queue attributes. Important: Pass the same attributes you used to lookup the factory.
*/
